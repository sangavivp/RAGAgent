...
- confidence:
  - A float between 0 and 1 indicating how confident you are in your analysis whether clarification is required or not. You are an expert at this task, so be generally confident (0.7+) unless the you are not confident with your analysis. For clear-cut cases, be very confident (0.9+).
